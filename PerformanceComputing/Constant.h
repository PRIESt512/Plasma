...
const double ELECTRON_SPEED_DIMENSIONLESS_UNIT = sqrt(2 * BOLTZMANN_CONSTANT*TEMPERATURE / ELECTRONS_MASS);
const double CARBON_SPEED_DIMENSIONLESS_UNIT = sqrt(2 * BOLTZMANN_CONSTANT*TEMPERATURE / CARBONS_MASS);
