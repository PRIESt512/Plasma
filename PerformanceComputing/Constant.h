...
const double ELECTRON_SPEED_DIMENSIONLESS_UNIT = sqrt(2 * BOLTZMANN_CONSTANT*ELECTRONS_TEMPERATURE / ELECTRONS_MASS);
const double CARBON_SPEED_DIMENSIONLESS_UNIT = sqrt(2 * BOLTZMANN_CONSTANT*CARBONS_TEMPERATURE / CARBONS_MASS);
const double HELLIUM_SPEED_DIMENSIONLESS_UNIT = sqrt(2 * BOLTZMANN_CONSTANT*HELIUMS_TEMPERATURE / HELIUMS_MASS);